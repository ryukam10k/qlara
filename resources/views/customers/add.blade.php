...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header"><a href="/customers/"><i class="fas fa-list-alt"></i> 顧客</a> ／ 追加</div>
                <div class="card-body">
                    @if (count($errors) > 0)
                    <div>
                        <ul>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th>略称</th>
                            <td><input type="text" class="form-control" name="short_name" value="{{old('short_name')}}" required></td>
                        </tr>
                        <tr>
                            <th>正式名称（会社名）</th>
                            <td><input type="text" class="form-control" name="full_name" value="{{old('full_name')}}" required></td>
                        </tr>
                        <tr>
                            <th>グループ名</th>
